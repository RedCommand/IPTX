...
function ProfileScreen({navigation}: any): React.JSX.Element {
  ...
  const toggleCreateProfilePopup = async (
    index: number,
    username?: string,
    password?: string,
    baseURL?: string,
        ...
        <View
          ...
          <View className="flex flex-col justify-center items-center w-full pt-2">
            <View
              ...
              <Text
                className="text-center text-lg font-semibold pt-2"
              ...
              <View className="flex-1 gap-2 justify-center">
                ...
                <Text className="text-xl pl-4" style={{color: theme.text}}>
                  ...
                  <Text className="text-lg" style={{color: theme.primary}}>
                    {new Date(
                      parseInt(user?.expiration.toString() + '000'),
                    ).toLocaleString()}
                  </Text>
                </Text>
                <Text className="text-xl pl-4" style={{color: theme.text}}>
              ...
              <Text
                className="absolute text-xl bottom-0 m-2"
                style={{color: theme.text}}>
          ...
          <View className="flex flex-col justify-center items-center w-full pt-8">
            <SelectDropdown
              ...
              renderButton={(selectedItem, isOpened) => {
                return (
                  <View
                    className="w-10/12 h-12 justify-center items-center px-3 flex flex-row rounded-lg "
                    ...
                    <Icon
                      ...
                      style={{color: theme.secondary, fontSize: 24}}
                    />
                  </View>
                );
              }}
          ...
          <View className="absolute bottom-0 right-0 m-4 pb-[7.5rem] w-11/12">
            <SelectDropdown
              ...
              renderButton={(selectedItem, isOpened) => {
                return (
                  <TouchableOpacity className="rounded-full flex items-end w-[98%]">
                    <View
              ...
              renderItem={(item, index, isSelected) => {
                return (
                  <View className="items-center w-full">
                    <View
                      className="h-12 justify-center items-center px-3 flex flex-row rounded-lg w-full"
                      style={{backgroundColor: theme.card}}>
                      <Text
                        numberOfLines={1}
                        ellipsizeMode="tail"
                        className="text-lg w-full flex font-semibold">
                        {item?.name}
                      </Text>
                    </View>
                    {index !== 1 && (
              ...
              <View className="rounded-lg items-center flex p-4">
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    if (
                      !splitURL[1].includes('username=') ||
                      !splitURL[1].includes('password=')
                    ) {
                      return;
                    }
